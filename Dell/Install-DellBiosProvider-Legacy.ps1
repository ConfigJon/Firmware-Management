<#
    .DESCRIPTION
        Import the Dell Command | PowerShell Provider module (Version 2.3.1 and earlier)
    ...
    .EXAMPLE
        Running in a full Windows OS and installing from the internet    
            Install-DellBiosProvider-Legacy.ps1

        Running in WinPE
            Install-DellBiosProvider-Legacy.ps1 -ModulePath DellBIOSProvider -DllPath DllFiles
	...
	.CHANGELOG
        ...
        2021-03-24 - This script works with the DellBIOSProvider module version 2.3.1 and earlier. This script will no longer be updated.
                     See the newer version of "Install-DellBiosProvider.ps1 on my GitHub for version 2.4 and newer support"
